...
declare module sequelize {
   ...
   */
  interface Connection extends SequelizeStaticAndInstance, Hooks<any> {
    /**
     ...
     */
    import<TInstance, TAttributes>(path: string, defineFunction?: (sequelize: Connection, dataTypes: DataTypes) => Model<TInstance, TAttributes>): Model<TInstance, TAttributes>;
