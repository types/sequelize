...
export interface ModelHookOptions<M extends Model = Model> {
    ...
    beforeDelete(instance: M, options: InstanceDestroyOptions): HookReturn
    afterDestroy(instance: M, options: InstanceDestroyOptions): HookReturn
    afterDelete(instance: M, options: InstanceDestroyOptions): HookReturn
    ...
    beforeBulkDelete(options: DestroyOptions): HookReturn
    afterBulkDestroy(options: DestroyOptions): HookReturn
    afterBulkDelete(options: DestroyOptions): HookReturn
...
export class Hooks {
    ...
    public static addHook<C extends typeof Hooks, K extends keyof SequelizeHooks>(hookType: K, fn: SequelizeHooks[K]): C
    public static hook<C extends typeof Hooks, K extends keyof SequelizeHooks>(
        hookType: K,
        name: string,
        fn: SequelizeHooks[K]
    ): C
    public static hook<C extends typeof Hooks, K extends keyof SequelizeHooks>(hookType: K, fn: SequelizeHooks[K]): C
    ...
    public hook<K extends keyof SequelizeHooks>(hookType: K, name: string, fn: SequelizeHooks[K]): this
    public hook<K extends keyof SequelizeHooks>(hookType: K, fn: SequelizeHooks[K]): this
